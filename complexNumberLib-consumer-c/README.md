...
```bash
C:\project-coding\cpp\202512\cpp-c-style-lib\complexNumberLib-consumer-c>C:\project-coding\cpp\202512\cpp-c-style-lib\complexNumberLib-consumer-c\build\Release\complexNumberTestC.exe
a + b = (6, 8)
a - b = (-2, -2)
a * b = (-7, 22)
