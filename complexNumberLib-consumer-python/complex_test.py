...
if os.name == 'nt':  # Windows
    # Go up one directory, then to generated_libs/complexNumber/bin/complexNumbers.dll
    lib_path = os.path.join(script_dir, "..", "generated_libs", "complexNumber", "bin", "complexNumbers.dll")
    lib_path = os.path.normpath(lib_path)  # Normalize the path
else:  # Linux/Mac
    lib_path = os.path.join(script_dir, "..", "generated_libs", "complexNumber", "lib", "libcomplexNumbers.so")
